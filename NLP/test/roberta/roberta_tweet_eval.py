...
start = time()
pipe = pipeline(model="cardiffnlp/twitter-roberta-base-sentiment", framework="tf", device=0)     # devices -1 : CPU, 0 : GPU
end = time()
...
for batch_size in [1, 2]:
	...
	labeling = {'LABEL_2': 2, 'LABEL_1' : 1, 'LABEL_0' : 0}	
...
# Save result csv 
result.to_csv('./result_roberta_tweet_eval_batch_size_n.csv', index=False)

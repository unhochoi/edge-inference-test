...
start = time()
pipe = pipeline(model="joeddav/distilbert-base-uncased-agnews-student", framework="tf", device=0)     # devices -1 : CPU, 0 : GPU
end = time()
...
for batch_size in [1, 2]:
	...
	labeling = {'science/tech': 3, 'business': 2, 'sports' : 1, 'the world' : 0}
...
# Save result csv 
result.to_csv('./result_distilbert_ag_news_batch_size_n.csv', index=False)
